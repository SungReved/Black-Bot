...
this.sendMessage(m.chat, {text: `لا يـوجـد لـديـك مـال بـلاك بـوت`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 𝗦𝘂𝗽𝗲𝗿 𝗚𝗮𝘁𝗮𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + ' مـال بـلاك بـوت')  
break
}}} catch (e) {
console.error(e)
} finally {
...
if (db.data.chats[m.chat].reaction && m.text.match(/(بلاك|غوكو|بلاك غوكو|غوكو بلاك|غوكو|سونغ|سونغ عمك|بوت|بوته|ous|ate|and|but|ify)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'ᯓ 𝅧𝅦𝑩𝑳𝑨𝑪𝑲 𝑩𝑶𝑻˖𖥔') :
...
"thumbnail": apii.data, 
"title": [wm, '' + gt + '', 'ᯓ 𝅧𝅦𝑩𝑳𝑨𝑪𝑲 𝑩𝑶𝑻˖𖥔'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://whatsapp.com/channel/0029Vb1oHBiI7BeKAWWNJo2C' }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '' + gt + '', 'ᯓ 𝅧𝅦𝑩𝑳𝑨𝑪𝑲 𝑩𝑶𝑻˖𖥔'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
